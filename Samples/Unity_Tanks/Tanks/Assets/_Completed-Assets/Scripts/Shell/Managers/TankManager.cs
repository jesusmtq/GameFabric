...
namespace Complete
{
    ...
    public class TankManager
    {
        ...
        private Guid _m_TankId;
        private bool changecolor = false;
        public Guid m_TankId
        {
            get
            {
                return (_m_TankId);
            ...
            {
                _m_TankId = value;
                m_Shooting.OwningTankId = value;
                m_Health._TankId = value;
            }
        }

        public void SetDamage(float health)
        {
            m_Health.SetDamage(health);
        }

        private Guid _m_AssociatedUserId;
        public Guid m_AssociatedUserId
        {
            get
            {
                return (_m_AssociatedUserId);
            }
            set
            {
                _m_AssociatedUserId = value;
                m_Health.m_AssociatedUserId = value;
            }
        }
